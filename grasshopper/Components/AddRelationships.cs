...
//             : base(
//                 "Add Relationships to a Model Assembly",
//                 "AR",
//                 "Add Relationship(s) to a Model Assembly by providing Source and Target Speckle Object(s) to an Assembly, with respective Relationship Type(s) as text.",
//                 "Model",
//                 "Properties"
//             )
//         { }
...
//             {
//                 this.AddRuntimeMessage(GH_RuntimeMessageLevel.Remark, "No Source Model supplied. Using Assembly itself as source.");
//             }        
//             
//             var targets = new List<IGH_Goo>();
//             if (!DA.GetDataList(2, targets))
//             {
//                 this.AddRuntimeMessage(GH_RuntimeMessageLevel.Remark, "No Target Model supplied. Using Assembly itself as target.");
//             }
//             
...
//                 else
//                 {
//                     this.AddRuntimeMessage(GH_RuntimeMessageLevel.Error, string.Format("Error: Source Object is not a Model Entity: {0}.", remark));
//                     return;
//                 }
//             }
//             
...
//                 else
//                 {
//                     this.AddRuntimeMessage(GH_RuntimeMessageLevel.Error, string.Format("Error: Target Object is not a Model Entity: {0}.", remark));
//                     return;
//                 }
//             }
//             
